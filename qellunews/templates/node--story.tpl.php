...
<?php if ($display_submitted): ?>
 	<div class="submitted">
	  <?php print format_date($created, 'custom', 'l,  d \d\e F \d\e\l Y'); ?>  | <a href="<?php print ($teaser) ? $path : ""; ?>#comments"><fb:comments-count href=<?php print $path; ?>></fb:comments-count> comentarios</a>
    </div>
  <?php endif; ?>
    ...
    <div class="content"<?php print $content_attributes; ?>>
      <div id="tour-bar">
      	<div class="bar-reserva">
        	<h5>&iquest;Deseas saber m&aacute;s?</h5>
